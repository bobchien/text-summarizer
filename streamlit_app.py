...
def build_model_pipeline(config, text_preprocessors):
    ...
    if not app_local:
        ...
        checkpoint_vocab = f"model/assets/{lang}_vocab.txt"
        checkpoint_data  = "model/variables/variables.data-00000-of-00001"
        checkpoint_index = "model/variables/variables.index"
        checkpoint_model = "model/saved_model.pb"
